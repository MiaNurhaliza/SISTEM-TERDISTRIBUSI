...
class _UpdateMahasiswaState extends State<UpdateMahasiswa> {
  ...
  Future<void> updateMahasiswa() async {
    String urlInsert =
        "http://192.168.140.103:9001/api/v1/mahasiswa/${id}?nama=${nama.text}&&email=${email.text}&&tglLahir=${"${tglLahir.toLocal()}".split(" ")[0]}";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 20, 184, 170),
      ),
      body: Center(
        child: Container(
